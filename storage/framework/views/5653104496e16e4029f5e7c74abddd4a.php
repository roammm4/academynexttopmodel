...
<body class="bg-black text-white min-h-screen relative overflow-x-hidden">
  ...
  <div class="relative pt-10">
    <div class="hidden sm:block">
      <div class="absolute top-[20px] left-1/2 transform -translate-x-1/2 z-20">
        <img src="<?php echo e(asset('img/home.jpg')); ?>" alt="Model" class="w-[550px] h-auto relative scale-in hover-scale" loading="lazy">
        <!-- Teks Founder -->
        <div class="absolute bottom-[30%] right-[-80px] text-right z-30 max-w-[280px] slide-in-right">
          <p class="text-white text-[16px] leading-tight font-light">
            <?php echo e(__('messages.ceo_founder_coach')); ?><br>
            <span class="font-semibold"><?php echo e(__('messages.olivarie')); ?></span><br>
            <span class="opacity-80 text-[15px]"><?php echo e(__('messages.miss_inter')); ?></span>
          </p>
        </div>
    ...
    <section class="flex flex-col md:flex-row justify-between items-start px-4 md:px-[70px] mt-[-80px] relative z-10">
        <div class="flex-1 pt-8 md:pt-14 md:text-left text-center hero-animate slide-in-left">
          <p class="text-[20px] sm:text-[24px] md:text-[28px] leading-snug opacity-80 font-light">
            <?php echo e(__('messages.hero_slogan_1')); ?><br><?php echo e(__('messages.hero_slogan_2')); ?><br><?php echo e(__('messages.hero_slogan_3')); ?>
          ...
          <a href="http://wa.me/+6281219762427" target="_blank"
            ...
            <?php echo e(__('messages.lets_collaborate')); ?> <span class="ml-2">↗</span>
        </a>
      </div>
      <div class="flex-1 md:text-right text-center md:mt-0 mt-8 pt-8 md:pt-14 hero-animate slide-in-right">
          <p class="text-[18px] sm:text-[20px] md:text-[24px] leading-snug opacity-80 font-light">
            <?php echo e(__('messages.hero_slogan_4')); ?>
  ...
  <div class="flex flex-col items-center sm:hidden px-4 pt-6">
    ...
    <div class="relative w-[500px] h-auto mb-4">
      <img src="<?php echo e(asset('img/home.jpg')); ?>" alt="Model" class="w-full h-auto rounded-lg shadow-lg hover-scale" loading="lazy">
      ...
      <div class="absolute top-[60%] right-[-40px] pr-4 text-right z-10 max-w-[220px] slide-in-right">
        <p class="text-white text-[15px] leading-tight font-light">
          <?php echo e(__('messages.ceo_founder_coach')); ?><br>
          <span class="font-semibold"><?php echo e(__('messages.olivarie')); ?></span><br>
          <span class="opacity-80 text-[14px]"><?php echo e(__('messages.miss_inter')); ?></span>
        </p>
      </div>
    </div>
...
<section class="hidden sm:flex mt-[250px] flex h-screen fade-in">
  ...
  <div class="w-1/2 overflow-hidden">
    <img src="<?php echo e(asset('img/becomeamodel.png')); ?>" alt="Model Image" class="w-full h-full object-cover hover-scale" loading="lazy">
  </div>
  ...
  <div class="w-1/2 px-[60px] py-[80px] flex flex-col justify-center bg-black">
    <h1 class="font-['Fondamento'] text-[60px] leading-tight mb-[30px] slide-in-left">
      <?php echo e(__('messages.about_us2')); ?>

    </h1>
    <p class="text-[15px] mb-[20px] leading-[1.8] slide-in-left">
      <?php echo e(__('messages.about_us_desc_1')); ?>

    </p>
    <p class="text-[15px] mb-[20px] leading-[1.8] slide-in-left">
      <?php echo e(__('messages.about_us_desc_2')); ?>
    ...
    <a href="http://wa.me/+6281219762427" class="flex items-center border border-white rounded-full pl-8 pr-2 py-2 mt-5 w-[250px] h-[60px] group transition-colors duration-300 bg-black hover-lift slide-in-left">
      <span class="text-white text-lg tracking-wide flex-1"><?php echo e(__('messages.more_info')); ?></span>
...
<section id="meet-our-talent-mobile" class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <div class="w-full flex flex-col items-center mb-4">
    <p class="font-['Fondamento'] text-white text-[70px] leading-none tracking-wider fade-in"><?php echo e(__('messages.talent_our')); ?></p>
    <p class="font-['Fondamento'] text-white text-[70px] leading-none tracking-wider -mt-2 fade-in"><?php echo e(__('messages.talent_talents')); ?></p>
  </div>
  <?php
    $talentCards = [
      ['img' => 'img/talent/model1.png', 'title' => __('messages.talent_meet')],
      ['img' => 'img/talent/model3.jpg', 'title' => __('messages.talent_new')],
      ['img' => 'img/talent/model2.png', 'title' => __('messages.talent_faces')],
      ['img' => 'img/talent/model4.jpg', 'title' => __('messages.talent_explore')],
      ['img' => 'img/talent/model5.jpg', 'title' => __('messages.talent_popular')],
    ];
    $talenSectionLinksMobile = [
      __('messages.talent_meet') => '#meet-our-talent-mobile',
      __('messages.talent_new') => '#new-models-mobile',
      __('messages.talent_faces') => '#face-of-models-mobile',
      __('messages.talent_explore') => url('/model'),
      __('messages.talent_popular') => '#popular-models-mobile',
    ];
    $talenSectionLinksDesktop = [
      ...
      __('messages.talent_popular') => '#popular-models',
    ];
  ?>
  <?php $__currentLoopData = $talentCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="relative w-full max-w-[280px] h-[350px] rounded-[20px] overflow-hidden mb-4 stagger-item hover-lift">
      <img src="<?php echo e(asset($card['img'])); ?>" alt="<?php echo e($card['title']); ?>" class="w-full h-full object-cover block rounded-[20px] hover-scale" loading="lazy">
      <div class="absolute top-0 left-0 right-0 p-[15px] flex justify-between items-start">
        <span class="font-['Newsreader'] text-[18px] text-white z-10 max-w-[150px] leading-tight"><?php echo e($card['title']); ?></span>
        <a href="<?php echo e($talenSectionLinksMobile[$card['title']] ?? '#'); ?>" class="bg-white text-black rounded-full w-[32px] h-[32px] flex items-center justify-center font-bold text-[14px] mt-1 transition hover:bg-black hover:text-white z-10">
          ↗
        </a>
      </div>
    </div>
  ...
  <p class="font-['Newsreader'] text-[20px] text-center text-gray-300 leading-relaxed mt-2 mb-6 max-w-xs fade-in">
    <?php echo e(__('messages.talent_ignite')); ?>
...
<section id="meet-our-talent-desktop" class="hidden sm:block mt-[300px] bg-black fade-in">
  <div class="flex justify-center items-center md:gap-[120px] gap-[60px] md:flex-row flex-col">
    ...
    <div class="flex md:flex-col flex-row gap-[30px] md:gap-[30px] gap-4 flex-wrap justify-center">
      <div class="relative w-[280px] h-[350px] rounded-[20px] overflow-hidden stagger-item hover-lift">
        <img src="<?php echo e(asset('img/talent/model1.png')); ?>" alt="<?php echo e(__('messages.talent_meet')); ?>" class="w-full h-full object-cover block rounded-[20px] hover-scale" loading="lazy">
        <div class="absolute top-0 left-0 right-0 p-[15px] flex justify-between items-start">
          <span class="font-['Newsreader'] text-[22px] text-white z-10 max-w-[150px] leading-tight"><?php echo e(__('messages.talent_meet')); ?></span>
          <a href="<?php echo e($talenSectionLinksDesktop[__('messages.talent_meet')]); ?>" class="bg-white text-black rounded-full w-[32px] h-[32px] flex items-center justify-center font-bold text-[16px] mt-1 transition hover:bg-black hover:text-white z-10">↗</a>
        </div>
      </div>
      <div class="relative w-[280px] h-[350px] rounded-[20px] overflow-hidden stagger-item hover-lift">
        <img src="<?php echo e(asset('img/talent/model2.png')); ?>" alt="<?php echo e(__('messages.talent_faces')); ?>" class="w-full h-full object-cover block rounded-[20px] hover-scale" loading="lazy">
        <div class="absolute top-0 left-0 right-0 p-[15px] flex justify-between items-start">
          <span class="font-['Newsreader'] text-[18px] text-white z-10 max-w-[150px] leading-tight"><?php echo e(__('messages.talent_faces')); ?></span>
          <a href="<?php echo e($talenSectionLinksDesktop[__('messages.talent_faces')]); ?>" class="bg-white text-black rounded-full w-[28px] h-[28px] flex items-center justify-center font-bold text-[14px] mt-1 transition hover:bg-black hover:text-white z-10">↗</a>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col items-center gap-[20px] max-w-[320px]">
      ...
      <div class="relative w-[320px] h-[400px] rounded-[20px] overflow-hidden stagger-item hover-lift">
        <img src="<?php echo e(asset('img/talent/model3.jpg')); ?>" alt="<?php echo e(__('messages.talent_new')); ?>" class="w-full h-full object-cover block rounded-[20px] hover-scale" loading="lazy">
        <div class="absolute top-0 left-0 right-0 p-[15px] flex justify-between items-start">
          <span class="font-['Newsreader'] text-[18px] text-white z-10 max-w-[150px] leading-tight"><?php echo e(__('messages.talent_new')); ?></span>
          <a href="<?php echo e($talenSectionLinksDesktop[__('messages.talent_new')]); ?>" class="bg-white text-black rounded-full w-[28px] h-[28px] flex items-center justify-center font-bold text-[14px] mt-1 transition hover:bg-black hover:text-white z-10">↗</a>
        </div>
      </div>
    ...
    <div class="flex flex-col gap-[30px]">
      <div class="relative w-[280px] h-[350px] rounded-[20px] overflow-hidden stagger-item hover-lift">
        <img src="<?php echo e(asset('img/talent/model4.jpg')); ?>" alt="<?php echo e(__('messages.talent_explore')); ?>" class="w-full h-full object-cover block rounded-[20px] hover-scale" loading="lazy">
        <div class="absolute top-0 left-0 right-0 p-[15px] flex justify-between items-start">
          <span class="font-['Newsreader'] text-[18px] text-white z-10 max-w-[150px] leading-tight"><?php echo e(__('messages.talent_explore')); ?></span>
          <a href="<?php echo e($talenSectionLinksDesktop[__('messages.talent_explore')]); ?>" class="bg-white text-black rounded-full w-[28px] h-[28px] flex items-center justify-center font-bold text-[14px] mt-1 transition hover:bg-black hover:text-white z-10">↗</a>
        </div>
      </div>
      <div class="relative w-[280px] h-[350px] rounded-[20px] overflow-hidden stagger-item hover-lift">
        <img src="<?php echo e(asset('img/talent/model5.jpg')); ?>" alt="<?php echo e(__('messages.talent_popular')); ?>" class="w-full h-full object-cover block rounded-[20px] hover-scale" loading="lazy">
        <div class="absolute top-0 left-0 right-0 p-[15px] flex justify-between items-start">
          <span class="font-['Newsreader'] text-[18px] text-white z-10 max-w-[150px] leading-tight"><?php echo e(__('messages.talent_popular')); ?></span>
          <a href="<?php echo e($talenSectionLinksDesktop[__('messages.talent_popular')]); ?>" class="bg-white text-black rounded-full w-[28px] h-[28px] flex items-center justify-center font-bold text-[14px] mt-1 transition hover:bg-black hover:text-white z-10">↗</a>
        </div>
      </div>
    </div>
  </div>
...
<section id="meet-our-talent-mobile" class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <h2 class="font-['Fondamento'] text-white text-[70px] text-center mb-8 fade-in"><?php echo e(__('messages.meet_talents')); ?></h2>
  <div class="grid grid-cols-2 gap-4 w-full max-w-[520px] stagger-container">
  <?php $__currentLoopData = $featuredTalents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php if($ft->talent): ?>
    <div class="relative w-[250px] h-[320px] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('storage/' . $ft->talent->photo)); ?>" alt="<?php echo e($ft->talent->nama_model); ?>" class="w-full h-full object-cover hover-scale" loading="lazy">
    </div>
  <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
  <div class="flex justify-center mt-8 mb-12 w-full fade-in">
    <a href="<?php echo e(url('/models')); ?>">
      <button class="flex items-center gap-2 bg-transparent border border-white rounded-full px-6 py-3 text-white hover-lift">
        <?php echo e(__('messages.find_models')); ?>
...
<section id="meet-our-talent" class="hidden sm:block mt-[100px] bg-black fade-in">
  <div class="max-w-[1200px] mx-auto px-4">
    <h2 class="font-['Fondamento'] text-white text-[60px] text-center mb-16 fade-in"><?php echo e(__('messages.meet_talents')); ?></h2>
    <div class="grid grid-cols-4 gap-8 place-items-center stagger-container">
      <?php $__currentLoopData = $ourTalents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ht): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="relative w-[250px] h-[320px] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
          <img src="<?php echo e(asset('storage/' . $ht->image)); ?>" alt="Talent <?php echo e($loop->iteration); ?>" class="w-full h-full object-cover hover-scale" loading="lazy">
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
  <div class="flex justify-center mt-8 mb-12 w-full fade-in">
...
<section id="face-of-models-mobile" class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <h2 class="font-['Fondamento'] text-white text-[70px] text-center mb-8 fade-in"><?php echo e(__('messages.face_of_models')); ?></h2>
    <div class="grid grid-cols-2 gap-4 w-full max-w-[520px] stagger-container">
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model1.jpg')); ?>" alt="Raynelle" class="w-full h-full object-cover hover-scale" loading="lazy">
    ...
    <!-- Model Card 2 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model2.jpg')); ?>" alt="Aleeya" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
    ...
    <!-- Model Card 3 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model3.jpg')); ?>" alt="Cheva" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
    ...
    <!-- Model Card 4 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model4.jpg')); ?>" alt="Kalyca" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
    ...
    <!-- Model Card 5 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model5.jpg')); ?>" alt="Caren" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
    ...
    <!-- Model Card 6 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model6.jpg')); ?>" alt="Camilla" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
    ...
    <!-- Model Card 7 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model7.jpg')); ?>" alt="Maya" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
    ...
    <!-- Model Card 8 -->
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/new/model8.jpg')); ?>" alt="Naila" class="w-full h-full object-cover hover-scale" loading="lazy">
      <div class="absolute top-3 right-3 z-10 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" class="w-8 h-8">
        <path
          d="M5 12h10M15 8l4 4-4 4"
  ...
  <!-- <?php echo e(__('messages.find_models')); ?> Button -->
  <div class="flex justify-center mt-8 mb-12 w-full fade-in">
    <button class="flex items-center gap-2 bg-transparent border border-white rounded-full px-6 py-3 text-white hover-lift">
      <?php echo e(__('messages.find_models')); ?>
...
<!-- Faces of Models Section -->
<section id="meet-our-talent" class="hidden sm:block mt-[100px] bg-black fade-in">
  <div class="max-w-[1200px] mx-auto px-4">
    <h2 class="font-['Fondamento'] text-white text-[60px] text-center mb-16 fade-in"><?php echo e(__('messages.face_of_models')); ?></h2>
    <div class="grid grid-cols-4 gap-8 place-items-center stagger-container">
    <?php $__currentLoopData = $featuredTalents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($ft->talent): ?>
    <div class="relative w-[250px] h-[320px] rounded-[20px] overflow-hidden bg-neutral-800 flex flex-col stagger-item hover-lift">
      <img src="<?php echo e(asset('storage/' . $ft->talent->photo)); ?>" alt="<?php echo e($ft->talent->nama_model); ?>" class="w-full h-full object-cover hover-scale" loading="lazy">
      <a href="<?php echo e(url('/portofolio/' . $ft->talent->id_model)); ?>"
      ...
      <div class="absolute bottom-2 p-1 left-2 font-semibold text-black  text-[28px] font-['Newsreader']">
    <?php echo e(explode(' ', $ft->talent->nama_model)[0]); ?>
...
<section id="new-models-mobile" class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <h2 class="font-['Fondamento'] text-white text-[70px] text-center mb-8 fade-in"><?php echo e(__('messages.new_models_title2')); ?></h2>
...
<section id="new-models" class="hidden sm:block mt-[100px] bg-black fade-in">
  <div class="max-w-[1200px] mx-auto px-4">
    <h2 class="font-['Fondamento'] text-white text-[60px] text-center mb-16 fade-in"><?php echo e(__('messages.new_models_title2')); ?></h2>
...
<section id="popular-models-mobile" class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <h2 class="font-['Fondamento'] text-white text-[70px] text-center mb-8 fade-in"><?php echo e(__('messages.new_popular_title2')); ?></h2>
  <div class="grid grid-cols-2 gap-4 w-full max-w-[520px] stagger-container">
    <div class="relative w-full aspect-[5/7] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
      <img src="<?php echo e(asset('img/models/model1.png')); ?>" alt="Aisyah" class="w-full h-full object-cover hover-scale" loading="lazy">
...
<section id="popular-talent" class="hidden sm:block mt-[100px] bg-black fade-in">
  <div class="max-w-[1200px] mx-auto px-4">
    <h2 class="font-['Fondamento'] text-white text-[60px] text-center mb-16 fade-in"><?php echo e(__('messages.new_popular_title2')); ?></h2>

    <div class="grid grid-cols-4 gap-8 place-items-center stagger-container">
      <?php $__currentLoopData = $popularTalents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="relative w-[250px] h-[320px] rounded-[20px] overflow-hidden bg-neutral-800 stagger-item hover-lift">
          <img src="<?php echo e(asset('storage/' . $pt->image)); ?>" alt="Popular Talent <?php echo e($loop->iteration); ?>" class="w-full h-full object-cover hover-scale" loading="lazy">
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<section class="hidden sm:block mt-[160px] bg-black fade-in">
  <div class="max-w-[1200px] mx-auto px-4">
    ...
    <div class="text-center mb-16">
      <h2 class="font-['Fondamento'] text-white text-[70px] mb-8 fade-in"><?php echo e(__('messages.benefits_title')); ?></h2>
      <div class="flex justify-center gap-8 text-[30px] fade-in">
        <button onclick="showBenefits('clients')" id="clientsTab" class="text-white opacity-100 transition-opacity duration-300"><?php echo e(__('messages.benefits_clients')); ?></button>
        <button onclick="showBenefits('models')" id="modelsTab" class="text-white opacity-40 transition-opacity duration-300"><?php echo e(__('messages.benefits_models')); ?></button>
      </div>
    </div>
    ...
    <div id="clientsBenefits" class="grid grid-cols-3 gap-8 fade-in">
      ...
      <div class="bg-white rounded-[20px] p-4">
        ...
        <li><?php echo e(__('messages.benefits_clients_1')); ?>

        </li>
        <li><?php echo e(__('messages.benefits_clients_1b')); ?>
      ...
      <div class="bg-white rounded-[20px] p-4">
        ...
        <li><?php echo e(__('messages.benefits_clients_2')); ?></li>
        </ul>
      </div>
      ...
      <div class="bg-white rounded-[20px] p-4">
        ...
        <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
        <li><?php echo e(__('messages.benefits_clients_3')); ?></li>
        </ul>
      </div>
      ...
      <div class="bg-white rounded-[20px] p-4">
        ...
        <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
        <li><?php echo e(__('messages.benefits_clients_4')); ?></li>
        </ul>
      </div>
      ...
      <div class="bg-white rounded-[20px] p-4">
        ...
        <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
          <li><?php echo e(__('messages.benefits_clients_5')); ?></li>
        </ul>
      </div>
      ...
      <div class="bg-white rounded-[20px] p-4">
        ...
        <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
          <li><?php echo e(__('messages.benefits_clients_6')); ?></li>
        </ul>
      </div>
    </div>
    ...
    <div id="modelsBenefits" class="hidden fade-in">
      ...
      <div class="grid grid-cols-3 gap-8 mb-8 fade-in">
        ...
        <div class="bg-white rounded-[20px] p-4">
          ...
          <ul class="text-sm leading-relaxed text-black list-disc pl-4 space-y-2 font-semibold fade-in">
            <li><?php echo e(__('messages.benefits_models_1')); ?></li>
            <li><?php echo e(__('messages.benefits_models_1b')); ?></li>
          </ul>
        </div>
        ...
        <div class="bg-white rounded-[20px] p-4">
          ...
          <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
            <li><?php echo e(__('messages.benefits_models_2')); ?></li>
          </ul>
        </div>
        ...
        <div class="bg-white rounded-[20px] p-4">
          ...
          <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
            <li><?php echo e(__('messages.benefits_models_3')); ?></li>
            <li><?php echo e(__('messages.benefits_models_3b')); ?></li>
          </ul>
        </div>
      </div>
      ...
      <div class="flex justify-center gap-8 fade-in">
        ...
        <div class="bg-white rounded-[20px] p-4 w-[384px] fade-in"> <!-- Width sama dengan card di atas (1/3 dari total - gap) -->
          ...
          <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
            <li><?php echo e(__('messages.benefits_models_4')); ?></li>
          </ul>
        </div>
        ...
        <div class="bg-white rounded-[20px] p-4 w-[384px] fade-in">
          ...
          <ul class="text-sm leading-relaxed text-black list-disc pl-4 font-semibold fade-in">
            <li><?php echo e(__('messages.benefits_models_5')); ?></li>
          </ul>
        </div>
      </div>
    </div>
...
<section class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <!-- Judul -->
  <h2 class="font-['Fondamento'] text-white text-[70px] mb-8 text-center fade-in"><?php echo e(__('messages.benefits_title')); ?></h2>
  <!-- Tabs -->
  <div class="flex justify-center gap-4 mb-6 fade-in">
    <button id="mobileClientsTab" class="text-white text-[22px] font-bold opacity-100 border-b-2 border-white px-3 py-1 transition"><?php echo e(__('messages.benefits_clients')); ?></button>
    <button id="mobileModelsTab" class="text-white text-[22px] font-bold opacity-40 border-b-2 border-transparent px-3 py-1 transition"><?php echo e(__('messages.benefits_models')); ?></button>
  </div>
  <!-- Clients Benefits -->
  <div id="mobileClientsBenefits" class="flex flex-col gap-4 w-full max-w-[400px] fade-in">
    ...
    <div class="bg-white rounded-[20px] p-4">
      ...
      <ul class="text-sm leading-relaxed text-black list-disc pl-4 space-y-1 font-semibold fade-in">
        <li><?php echo e(__('messages.benefits_clients_1')); ?></li>
        <li><?php echo e(__('messages.benefits_clients_1b')); ?></li>
      </ul>
    </div>
    <!-- Client Card 2 -->
    <div class="bg-white rounded-[20px] p-4">
...
<section class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <!-- Judul -->
  <h1 class="font-['Fondamento'] text-[70px] text-center mb-4 fade-in"><?php echo e(__('messages.become_model_title')); ?></h1>
  <!-- Gambar -->
  <div class="w-full max-w-[320px] mb-4">
    <img src="<?php echo e(asset('img/becomeamodel.png')); ?>" alt="Model Image" class="w-full h-auto rounded-[20px] shadow-lg hover-scale" loading="lazy">
  </div>
  <!-- Deskripsi -->
  <div class="text-[15px] text-center text-white mb-4 leading-[1.8] slide-in-left">
    <?php echo e(__('messages.become_model_description')); ?> <br>
    <?php echo e(__('messages.become_model_description2')); ?>

  </div>
  <!-- Button -->
  <a href="<?php echo e(url('/joinacademy')); ?>" class="flex items-center justify-center border border-white rounded-full pl-8 pr-2 py-2 mt-2 w-[300px] h-[50px] group transition-colors duration-300 bg-black hover-lift slide-in-left">
    <span class="text-white text-lg tracking-wide flex-1"><?php echo e(__('messages.join_now')); ?></span>
...
<section class="hidden sm:flex mt-[200px] flex h-screen fade-in">
  ...
  <div class="w-1/2 px-[60px] py-[80px] flex flex-col justify-center bg-black">
    <h1 class="font-['Fondamento'] text-[60px] leading-tight mb-[30px] slide-in-left">
      <?php echo e(__('messages.become_model_title')); ?>

    </h1>
    <p class="text-[15px] mb-[20px] leading-[1.8] slide-in-left">
      <?php echo e(__('messages.become_model_description')); ?>
    ...
    <a href="<?php echo e(url('/joinacademy')); ?>" class="flex items-center border border-white rounded-full pl-8 pr-2 py-2 mt-5 w-[250px] h-[60px] group transition-colors duration-300 bg-black hover-lift slide-in-left">
      <span class="text-white text-lg tracking-wide flex-1"><?php echo e(__('messages.join_now')); ?></span>
      <span class="bg-white rounded-full w-12 h-12 flex items-center justify-center transition group-hover:bg-black ml-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-black group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
          <path stroke-linecap="round" stroke-linejoin="round" d="M8 16l7-7m0 0v6m0-6H9" transform="rotate(45 12 12)" />
  ...
  <!-- Right Panel -->
  <div class="w-1/2 overflow-hidden">
    <img src="<?php echo e(asset('img/becomeamodel.png')); ?>" alt="Model Image" class="w-full h-full object-cover">
  </div>
</section>

<!-- Hire Models Section Mobile -->
<section class="sm:hidden flex flex-col items-center bg-black px-4 pt-10 fade-in">
  <h1 class="font-['Fondamento'] text-[70px] text-center mb-2 text-white leading-none fade-in"><?php echo e(__('messages.hire_models_title')); ?></h1>
  <p class="text-[16px] text-center text-white leading-relaxed mb-8 fade-in">
    <?php echo e(__('messages.hire_models_description')); ?>
  ...
  <div class="grid grid-cols-2 gap-4 w-full max-w-[440px] stagger-container">
    ...
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Fathia.jpg')); ?>" alt="Fathia" class="w-full h-full object-cover hover-scale" loading="lazy" />
    ...
    <!-- Card 2 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Naila.jpg')); ?>" alt="Naila" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 3 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Rara.jpg')); ?>" alt="Rara" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 4 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Nazwa.jpg')); ?>" alt="Nazwa" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 5 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Afia.jpg')); ?>" alt="Afia" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 6 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Nikita.jpg')); ?>" alt="Nikita" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 7 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Raynelle.jpg')); ?>" alt="Raynelle" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 8 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Michelle.jpg')); ?>" alt="Michelle" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 9 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/BabyEyin.jpg')); ?>" alt="BabyEyin" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
    ...
    <!-- Card 10 -->
    <div class="relative w-full aspect-[5/7] rounded-[16px] bg-white shadow-lg overflow-hidden stagger-item hover-lift">
      <img src="<?php echo e(asset('img/hiremodel/Alexa.jpg')); ?>" alt="Alexa" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
      <div class="absolute top-3 right-3 z-10">
        <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
      </div>
      <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
  ...
  <p class="mt-8 text-center text-white underline cursor-pointer text-[16px] fade-in"><?php echo e(__('messages.see_more')); ?></p>
</section>

<!-- Hire Models Section -->
<section class="hidden sm:block py-20 px-4 bg-black fade-in">
  <h1 class="font-['Fondamento'] text-[56px] text-center mb-2 text-white leading-none fade-in"><?php echo e(__('messages.hire_models_title')); ?></h1>
  ...
  <div class="flex flex-col items-center">
    <?php $__currentLoopData = $hireModels->chunk(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIndex => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="flex flex-row gap-8 <?php echo e($rowIndex % 2 === 0 ? 'md:mr-20 mr-10' : 'md:ml-20 ml-10'); ?> stagger-container">
        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hireModels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="relative w-[200px] h-[260px] rounded-[16px] bg-white shadow-lg overflow-hidden flex flex-col justify-between stagger-item hover-lift">
            <img src="<?php echo e(asset('storage/' . $hireModels->photo)); ?>" alt="<?php echo e($hireModels->name); ?>" class="w-full h-full object-cover absolute inset-0 hover-scale" loading="lazy" />
            <div class="absolute top-3 right-3 z-10">
      <a href="<?php echo e(url('/portofolio/' . $hireModels->id_model)); ?>"
                <span class="flex items-center justify-center text-black text-xl font-bold">➝</span>
              </a>
            </div>
            <div class="absolute left-3 bottom-3 z-10 font-['Newsreader'] text-black text-left">
            <h3 class="text-[22px] font-bold leading-none" style="text-shadow: 0 0 4px #fff, 0 0 2px #fff;">
    <?php echo e(explode(' ', $hireModels->nama_model)[0]); ?>

</h3>
<p class="text-[13px] leading-none">
    <?php echo e(explode(',', $hireModels->city)[0]); ?>
  ...
  <p class="mt-10 text-center text-white underline cursor-pointer text-[16px] fade-in">
    <?php echo e(__('messages.see_more')); ?>
...
<section class="hidden sm:block px-[120px] py-[80px] w-full min-h-screen bg-black fade-in">
  <!-- Title -->
  <h2 class="text-white text-[64px] text-center mb-16 font-['Fondamento'] fade-in"><?php echo e(__('messages.why_choose_us_title')); ?></h2>
  ...
  <div class="flex">
    ...
    <div class="w-1/2 border-r border-white">
      ...
      <div class="p-8 flex flex-col border-b border-white">
        ...
        <div class="flex flex-col gap-2">
          <h3 class="text-xl font-semibold text-white fade-in"><?php echo e(__('messages.why_choose_us_1')); ?></h3>
          <p class="text-base text-gray-300 leading-relaxed fade-in">
            <?php echo e(__('messages.why_choose_us_1b')); ?>
      ...
      <div class="p-8 flex flex-col border-b border-white">
        ...
        <div class="flex flex-col gap-2">
          <h3 class="text-xl font-semibold text-white fade-in"><?php echo e(__('messages.why_choose_us_3')); ?></h3>
          <p class="text-base text-gray-300 leading-relaxed fade-in">
            <?php echo e(__('messages.why_choose_us_3b')); ?>
      ...
      <div class="p-8 flex flex-col">
        ...
        <div class="flex flex-col gap-2">
          <h3 class="text-xl font-semibold text-white fade-in"><?php echo e(__('messages.why_choose_us_5')); ?></h3>
          <p class="text-base text-gray-300 leading-relaxed fade-in">
            <?php echo e(__('messages.why_choose_us_5b')); ?>
    ...
    <div class="w-1/2 mt-24">
      ...
      <div class="h-[300px] p-8 border-b border-white">
        ...
        <h3 class="text-2xl font-semibold text-white mt-4 fade-in"><?php echo e(__('messages.why_choose_us_2')); ?></h3>
        <p class="text-base text-gray-300 mt-2 w-[500px] fade-in">
          <?php echo e(__('messages.why_choose_us_2b')); ?>
      ...
      <div class="h-[300px] p-8">
        ...
        <h3 class="text-2xl font-semibold text-white mt-4 fade-in"><?php echo e(__('messages.why_choose_us_4')); ?></h3>
        <p class="text-base text-gray-300 mt-2 w-[500px] fade-in">
          <?php echo e(__('messages.why_choose_us_4b')); ?>
...
<section class="sm:hidden px-6 sm:px-[120px] py-[80px] w-full min-h-screen bg-black fade-in">
  <!-- Title -->
  <h2 class="text-white text-[70px] sm:text-[64px] text-center mb-12 sm:mb-16 font-['Fondamento'] fade-in"><?php echo e(__('messages.why_choose_us_title')); ?></h2>
  ...
  <div class="flex flex-col sm:flex-row">
    ...
    <div class="w-full sm:w-1/2 border-b sm:border-b-0 sm:border-r border-white">
      ...
      <div class="p-6 sm:p-8 flex flex-col border-b border-white">
        ...
        <div class="flex flex-col gap-2">
          <h3 class="text-lg sm:text-xl font-semibold text-white fade-in"><?php echo e(__('messages.why_choose_us_1')); ?></h3>
      ...
      <div class="p-6 sm:p-8 border-b border-white">
        ...
        <h3 class="text-lg sm:text-2xl font-semibold text-white mt-4 fade-in"><?php echo e(__('messages.why_choose_us_2')); ?></h3>
      ...
      <div class="p-6 sm:p-8 flex flex-col border-b border-white">
        ...
        <div class="flex flex-col gap-2">
          <h3 class="text-lg sm:text-xl font-semibold text-white fade-in"><?php echo e(__('messages.why_choose_us_3')); ?></h3>
          <p class="text-sm sm:text-base text-gray-300 leading-relaxed fade-in">
            <?php echo e(__('messages.why_choose_us_3b')); ?>
    ...
    <div class="w-full sm:w-1/2">
      ...
      <div class="p-6 sm:p-8">
        ...
        <h3 class="text-lg sm:text-2xl font-semibold text-white mt-4 fade-in"><?php echo e(__('messages.why_choose_us_4')); ?></h3>
        <p class="text-sm sm:text-base text-gray-300 mt-2 sm:w-[500px] fade-in">
          <?php echo e(__('messages.why_choose_us_4b')); ?>
  ...
  <div class="p-6 sm:p-8 flex flex-col">
        ...
        <div class="flex flex-col gap-2">
          <h3 class="text-lg sm:text-xl font-semibold text-white fade-in"><?php echo e(__('messages.why_choose_us_5')); ?></h3>
          <p class="text-sm sm:text-base text-gray-300 leading-relaxed fade-in">
            <?php echo e(__('messages.why_choose_us_5b')); ?>
...
<section class="hidden sm:flex flex-col items-center justify-center min-h-screen bg-black relative py-24 fade-in">
  <div class="flex items-center justify-center w-full">
    ...
    <div class="flex flex-col items-center justify-center h-[400px] z-20">
      <span class="font-fondamento text-white text-[110px] tracking-wider slide-in-left" style="writing-mode: vertical-rl; transform: rotate(180deg); letter-spacing: 0.1em;"><?php echo e(__('messages.contact')); ?></span>
    </div>
    <!-- Image -->
    <div class="mx-6 z-10">
      <img src="<?php echo e(asset('img/contact-model.png')); ?>" alt="Contact Model" class="w-[510px] h-[643px] object-cover rounded-[20px] bg-gray-200 scale-in hover-scale" loading="lazy" />
    </div>
    <!-- US -->
    <div class="flex items-end h-[700px] z-20">
      <span class="font-fondamento text-white text-[110px] tracking-wider slide-in-right"><?php echo e(__('messages.us')); ?></span>
    </div>
  </div>
  <!-- Card -->
  <div class="mt-4 bg-[#C4C4C4] rounded-[30px] shadow-lg w-[1000px] max-w-full px-12 py-8 flex flex-col items-center z-30 fade-in">
    <h2 class="font-fondamento text-black text-[50px] text-center mb-2 fade-in"><?php echo e(__('messages.where_dreams_walk_the_runway')); ?></h2>
    <p class="text-center text-gray-700 mb-6 text-[16px] max-w-[600px] fade-in"><?php echo e(__('messages.from_photoshoot_to_runway_coaching')); ?></p>
    <div class="flex w-full items-center gap-4">
      <span class="font-bold text-black text-[32px] fade-in"><?php echo e(__('messages.join_the_movement')); ?></span>
      <div class="flex flex-1 items-center rounded-[20px] px-2 py-2" style="background-color: rgba(59,56,62,0.08);">
        ...
        >
          <?php echo e(__('messages.lets_collaborate')); ?>
...
<section class="sm:hidden flex flex-col items-center justify-center min-h-screen bg-black relative py-24 fade-in">
  ...
  <div class="mt-4 bg-[#C4C4C4] rounded-[30px] shadow-lg w-[420px] h-[400px] px-6 sm:px-12 py-8 flex flex-col items-center z-30 fade-in">
    ...
    <h2 class="font-fondamento text-black text-[40px] text-center mb-2 fade-in"><?php echo e(__('messages.where_dreams_walk_the_runway')); ?></h2>
    <p class="text-center text-gray-700 mb-6 text-[14px] max-w-[600px] fade-in"><?php echo e(__('messages.from_photoshoot_to_runway_coaching')); ?></p>
    <div class="flex flex-col sm:flex-row w-full items-center gap-4">
      <span class="font-bold text-black text-[18px] text-center sm:text-left fade-in"><?php echo e(__('messages.join_the_movement')); ?></span>
      <div class="flex flex-1 items-center rounded-[20px] px-2 py-2" style="background-color: rgba(59,56,62,0.08);">
...
<footer class="w-full bg-white py-3 flex justify-between items-center px-8 text-black text-[16px] font-['Newsreader'] fade-in">
  <span><?php echo e(__('messages.footer')); ?></span>
  <span><?php echo e(__('messages.instagram')); ?></span>
</footer>
...
<?php /**PATH C:\xampp\htdocs\academyntm2-main\resources\views/welcome.blade.php ENDPATH**/ ?>