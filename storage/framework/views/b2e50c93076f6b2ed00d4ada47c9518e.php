    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="fixed w-full flex items-center justify-between h-14 bg-gray-800 text-white z-10">
            <div class="flex items-center pl-3 w-14 md:w-64 h-14">
                <img class="w-8 h-8 md:w-10 md:h-10 mr-2 rounded-full" src=<?php echo e(asset('img/logo.jpg')); ?> />
                <span class="hidden md:block font-bold text-lg"><?php echo e(__('messages.admin_label')); ?></span>
            </div>
            <div class="flex items-center header-right pr-4">
                ...
                <a href="#" class="ml-4 flex items-center hover:text-gray-300">
                    ...
                    <?php echo e(__('messages.admin_logout')); ?>
...
<div class="relative ml-4" x-data="{ open: false }" @click.away="open = false">
  <button @click="open = !open"
    ...
    <span class="text-sm font-medium"><?php echo e(strtoupper(app()->getLocale())); ?></span>
  ...
  <ul x-show="open" x-transition
      ...
      <a href="<?php echo e(route('lang.switch', 'id')); ?>"
                ...
                <ul class="py-4 space-y-1">
                    <li>
                        <a href="/admin" class="flex flex-row items-center h-11 hover:bg-gray-700 px-4 font-bold">
                            <span class="ml-2 text-sm tracking-wide truncate"><?php echo e(__('messages.admin_dashboard')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="/" class="flex flex-row items-center h-11 hover:bg-gray-700 px-4">
                            <span class="ml-2 text-sm tracking-wide truncate"><?php echo e(__('messages.admin_mainweb')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="/addmodel" class="flex flex-row items-center h-11 hover:bg-gray-700 px-4">
                            <span class="ml-2 text-sm tracking-wide truncate"><?php echo e(__('messages.admin_addmodell')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="profile-link" class="flex flex-row items-center h-11 hover:bg-gray-700 px-4">
                            <span class="ml-2 text-sm tracking-wide truncate"><?php echo e(__('messages.admin_userlist')); ?></span>
                        </a>
                    </li>
                    <!-- Settings Dropdown -->
        ...
        <main class="flex-1 ml-14 mt-14 md:ml-64 p-6 bg-gray-900 min-h-screen">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-4 text-white font-medium transition-transform duration-200 hover:shadow-2xl hover:scale-105 cursor-pointer" id="visitor-card">
                        ...
                        <div class="text-right">
                            <p class="text-2xl"><?php echo e($visitorCount); ?></p>
                            <p><?php echo e(__('messages.admin_active_users')); ?></p>
                        </div>
                    </div>
                    <div class="bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-4 text-white font-medium transition-transform duration-200 hover:shadow-2xl hover:scale-105 cursor-pointer" id="model-card">
                        ...
                        <div class="text-right">
                            <p class="text-2xl"><?php echo e($modelCount); ?></p>
                            <p><?php echo e(__('messages.admin_model_active')); ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div id="profile-table-content" class="hidden">
                <div class="bg-gray-800 rounded-lg p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-700">
                        <thead>
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider"><?php echo e(__('messages.admin_no')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider"><?php echo e(__('messages.admin_name')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider"><?php echo e(__('messages.admin_email')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider"><?php echo e(__('messages.admin_last_active')); ?></th>
                            </tr>
                        </thead>
                        <tbody class="bg-gray-900 divide-y divide-gray-700">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($i+1); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($u->name); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($u->email); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if(isset($u->is_online) && $u->is_online): ?>
                                        <span class="text-green-400 font-bold"><?php echo e(__('messages.admin_online')); ?></span>
                                    <?php elseif(isset($u->last_active) && $u->last_active): ?>
                                        <?php echo e(\Carbon\Carbon::parse($u->last_active)->diffForHumans()); ?>
            ...
            <div id="featured-talent-content" class="hidden">
                <div class="bg-gray-800 rounded-lg p-6">
                <h2 class="text-xl font-bold mb-4 text-white"><?php echo e(__('messages.face_of_models')); ?></h2>
                <form method="POST" action="<?php echo e(route('admin.featured-talents.save')); ?>">
                <?php echo csrf_field(); ?>

                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <?php for($i = 0; $i < 8; $i++): ?>
                    <div class="flex flex-col gap-2" 
                        x-data="{ selected: '<?php echo e(old('model_ids.' . $i, $featured[$i]->id_model ?? '')); ?>' }">
                        <label class="text-white font-semibold">Model <?php echo e($i + 1); ?></label>
                        ...
                        <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($model->id_model); ?>"><?php echo e($model->nama_model); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>

                        <template x-if="selected">
                        <img 
                            :src="'<?php echo e(asset('storage')); ?>/' + (<?php echo e(Js::from($models->pluck('photo', 'id_model'))); ?>[selected] ?? '')" 
        ...
        <form method="POST" action="<?php echo e(route('admin.ourtalent.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-4 gap-4">
            ...
            <div class="relative border-2 border-dashed border-gray-600 rounded-lg h-56 flex items-center justify-center bg-gray-700 group">
                <input type="file" name="images[]" class="hidden" accept="image/*" id="image-<?php echo e($i); ?>">
                
                <label for="image-<?php echo e($i); ?>" class="cursor-pointer flex flex-col items-center justify-center text-white group-hover:opacity-100 transition-opacity">
                <span class="text-4xl font-bold">+</span>
                <span class="text-sm mt-1">Upload</span>
                </label>

                <div class="absolute inset-0 hidden" id="preview-wrapper-<?php echo e($i); ?>">
                <img id="preview-<?php echo e($i); ?>" class="w-full h-full object-cover rounded-lg" />
                <div class="absolute bottom-2 right-2 flex gap-2">
                    <button type="button" onclick="editImage(<?php echo e($i); ?>)" class="bg-white text-black px-2 py-1 text-xs rounded">Edit</button>
                    <button type="button" onclick="removeImage(<?php echo e($i); ?>)" class="bg-red-600 text-white px-2 py-1 text-xs rounded">Delete</button>
                </div>
                </div>
            </div>
            <?php endfor; ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.populartalent.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-4 gap-4">
        <?php for($i = 0; $i < 8; $i++): ?>
    <?php
    ...
    <div class="relative border-2 border-dashed border-gray-600 rounded-lg h-56 flex items-center justify-center bg-gray-700 group">
        <input type="file" name="images[]" class="hidden" accept="image/*" id="popular-image-<?php echo e($i); ?>">

        <label for="popular-image-<?php echo e($i); ?>" class="cursor-pointer flex flex-col items-center justify-center text-white group-hover:opacity-100 transition-opacity">
            <span class="text-4xl font-bold">+</span>
            <span class="text-sm mt-1">Upload</span>
        </label>

        <div class="absolute inset-0 <?php echo e(($item && $item->image) ? '' : 'hidden'); ?>" id="popular-preview-wrapper-<?php echo e($i); ?>">
            <?php if($item && $item->image): ?>
                <img id="popular-preview-<?php echo e($i); ?>" src="<?php echo e(asset('storage/' . $item->image)); ?>" class="w-full h-full object-cover rounded-lg" />
                <div class="absolute bottom-2 right-2 flex gap-2">
                    <button type="button" onclick="editPopularImage(<?php echo e($i); ?>)" class="bg-white text-black px-2 py-1 text-xs rounded">Edit</button>
                    <button type="button" onclick="removePopularImage(<?php echo e($i); ?>)" class="bg-red-600 text-white px-2 py-1 text-xs rounded">Delete</button>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\academyntm2-main\resources\views/adminhome.blade.php ENDPATH**/ ?>