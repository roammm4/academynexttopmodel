...
<body class="bg-black min-h-screen">
  <div class="flex h-screen w-screen">
    ...
    <div class="hidden md:flex w-1/2 h-full bg-black items-center justify-center p-0 m-0">
      <img src="<?php echo e(asset('img/login.png')); ?>" alt="Model" class="w-full h-full object-contain m-0 p-0" style="object-position: left;">
    </div>
    ...
    <div class="w-full md:w-1/2 h-full flex items-center justify-start bg-black">
      <div class="max-w-md p-4 text-white mx-0 my-auto space-y-6 w-full ml-8">
        ...
        <h1 class="text-3xl font-semibold mb-2"><?php echo e(__('messages.login')); ?></h1>
        <p class="text-gray-400 text-sm mb-6"><?php echo e(__('messages.welcome_back')); ?></p>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="flex items-center mb-6">
            ...
            <span class="text-xs"><?php echo e(__('messages.remember_me')); ?></span>
          </div>

          <div class="flex items-center justify-between">
            <div class="text-xs">
              <?php echo e(__('messages.no_account')); ?> <a href="<?php echo e(url('/register')); ?>" class="text-white underline hover:text-gray-300"><?php echo e(__('messages.register_here')); ?></a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\academyntm2-main\resources\views/login.blade.php ENDPATH**/ ?>